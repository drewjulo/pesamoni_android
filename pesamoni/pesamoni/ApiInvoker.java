...
import pesamoni.auth.Authentication;
import pesamoni.auth.ApiKeyAuth;
import pesamoni.auth.HttpBasicAuth;
import pesamoni.request.GetRequest;
import pesamoni.request.PostRequest;
import pesamoni.request.PutRequest;
import pesamoni.request.DeleteRequest;
import pesamoni.request.PatchRequest;
...
public class ApiInvoker {
  ...
  */
  ...
  public static void initializeInstance(Cache cache, Network network, int threadPoolSize, ResponseDelivery delivery, int connectionTimeout) {
    ...
    INSTANCE.authentications.put("apipassword", new ApiKeyAuth("query", "apipassword"));
    INSTANCE.authentications.put("apiusername", new ApiKeyAuth("query", "apiusername"));
